...
class Settings {
    ...
    public static let HOST = "hanselngretel.com" /// if url has "www" then add host like "www.domain.com" else would be white screen
    
    public static let URL = "https://hanselngretel.com/"
